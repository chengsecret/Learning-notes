...
- 环境准备（创建数据库，maven导入依赖）
- mybatis核心配置文件
- 编写工具类（获得SqlSessionFactory对象）
- 实体类
- dao接口
- Mapper配置文件
- 测试
...
```xml
<mapper resource="com/ct/dao/UserMapper.xml"/>
```
...
public interface UserMapper {
    ...
    // 方法存在多个参数，所有的基本数据类型参数前面必须加上 @Param("id")注解
