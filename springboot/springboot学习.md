...
![1595396526609](springboot学习.assets/1595396526609.png)
...
![1595396173505](springboot学习.assets/1595396173505.png)
...
- 如果打包成功，则会在target目录下生成一个 jar 包
  ...
  ![1595397063721](springboot学习.assets/1595397063721.png)
...
- 打成了jar包后，就可以在任何地方运行了！OK
  ...
  ![1595397745294](springboot学习.assets/1595397745294.png)
...
​		![1595409428560](springboot学习.assets/1595409428560.png)
...
![1595415587435](springboot学习.assets/1595415587435.png)

**WebMvcAutoConfiguration**

我们在上面的自动配置类随便找一个打开看看，比如 ：`WebMvcAutoConfiguration`

![1595416894611](springboot学习.assets/1595416894611.png)
...
![img](springboot学习.assets/aHR0cHM6Ly9tbWJpei5xcGljLmNuL21tYml6X3BuZy91SkRBVUtyR0M3TDF2RlFNbmFSSUpTbWVaNThUMmVaaWNqYWZpYXdRTHA5dTh3YzRpYzFNank2T3lmaWJ6ZmpWb2ZlTDVwblMxTlNGS1ZqbElnNm5lSTl5U2cvNjQw)
...
4. 在SpringBoot的测试类下注入狗狗输出一下；
   ...
   ![1595466913174](springboot学习.assets/1595466913174.png)
...
8. IDEA 提示，springboot配置注解处理器没有找到，让我们看文档，我们可以查看文档，找到一个依赖！
   ...
   - 注解@ConfigurationProperties(prefix = "person")![1595464671197](springboot学习.assets/1595464671197.png)

     点击 open Decumentation进入官网![1595465051557](springboot学习.assets/1595465051557.png)
...
9. 确认以上配置都OK之后，我们去测试类中测试一下：
   ...
   ![1595467734622](springboot学习.assets/1595467734622.png)
...
3. 再次输出测试一下：指定配置文件绑定成功！
   ...
   ![1595467980925](springboot学习.assets/1595467980925.png)
...
![1595468231075](springboot学习.assets/1595468231075.png)
...
![1595480159290](springboot学习.assets/1595480159290.png)
...
![1595480813196](springboot学习.assets/1595480813196-1604927488087.png)
...
![1595484043622](springboot学习.assets/1595484043622-1604927488087.png)
...
![1595484511936](springboot学习.assets/1595484511936-1604927488087.png)

springboot 启动会扫描以下位置的application.properties或者application.yml文件作为Spring boot的默认配置文件：

![1595482583892](springboot学习.assets/1595482583892-1604927488087.png)
...
![1595493746481](springboot学习.assets/1595493746481.png)
...
![1595493884773](springboot学习.assets/1595493884773.png)
...
1. 我去新建一个项目测试：springboot-data-jdbc ; 引入相应的模块！基础模块
   ...
   ![1595741635349](springboot学习.assets/1595741635349.png)
...
1. 添加上 Druid 数据源依赖，这个依赖可以从Maven仓库官网[<font color=red>Maven Respository</font>](https://mvnrepository.com/artifact/com.alibaba/druid)中获取
   ...
   ![image-20200727215315060](springboot学习.assets/image-20200727215315060.png)
...
3. 数据源切换之后，在测试类中注入 DataSource，然后获取到它，输出一看便知是否成功切换；
   ...
   ![image-20200727222109497](springboot学习.assets/image-20200727222109497.png)
...
8. 输出结果 ：可见配置参数已经生效！
   ...
   ![image-20200727233746228](springboot学习.assets/image-20200727233746228.png)
...
![image-20200727233409312](springboot学习.assets/image-20200727233409312.png)

进入之后

![image-20200727233436583](springboot学习.assets/image-20200727233436583.png)
...
![image-20200728083023851](springboot学习.assets/image-20200728083023851.png)
...
![1595506633980](springboot学习.assets/1595506633980.png)

访问：只要是静态资源，SpringBoot就会去对应的路径寻找资源，我们这里访问：http://localhost:8080/webjars/jquery/3.4.1/jquery.js

![1595506019658](springboot学习.assets/1595506019658.png)

#### 第二种静态资源映射规则

1、那我们项目中要是使用自己的静态资源该怎么导入呢？我们看下一行代码；

![1595516976999](springboot学习.assets/1595516976999.png)
...
![1595517831392](springboot学习.assets/1595517831392.png)

6、比如我们访问 http://localhost:8080/1.js , 他就会去这些文件夹中寻找对应的静态资源文件；

![1595517869049](springboot学习.assets/1595517869049.png)
...
![1595518276475](springboot学习.assets/1595518276475.png)
...
![1595550098734](springboot学习.assets/1595550098734.png)
...
- 新建一个 index.html ，在我们上面的3个目录中任意一个；然后访问测试  http://localhost:8080/  看结果！
  ...
  ![1595550394178](springboot学习.assets/1595550394178.png)
...
2. 自己放一个图标在静态资源目录下，我放在 public 目录下
   ...
   ![1595554357772](springboot学习.assets/1595554357772.png)

3. 清除浏览器缓存`Ctrl + F5`！刷新网页，发现图标已经变成自己的了！

**2.2.x之后的版本（<font color=red>如2.3.0</font>）直接执行2和3就可以了**

![1595554118099](springboot学习.assets/1595554118099.png)
...
![1595555521951](springboot学习.assets/1595555521951.png)
...
![1595557596160](springboot学习.assets/1595557596160.png)
...
4. 启动测试！
   ...
   ![1595558424003](springboot学习.assets/1595558424003.png)
...
![1595560097876](springboot学习.assets/1595560097876.png)
...
2. 我们给 DispatcherServlet 中的 doDispatch方法 加个断点进行调试一下，因为所有的请求都会走到这个方法中
   ...
   ![1595564720595](springboot学习.assets/1595564720595.png)

3. 我们启动我们的项目，然后随便访问一个页面，看一下Debug信息；

   找到this(<font color=red>就是DispatcherServlet</font>)

   ![1595564823239](springboot学习.assets/1595564823239.png)

   找到视图解析器（<font color=red>viewResolvers</font>），我们看到我们自己定义的就在这里了；

   ![1595564942873](springboot学习.assets/1595564942873.png)
...
- 我们去浏览器访问一下：
  ...
  ![1595584684727](springboot学习.assets/1595584684727.png)
...
- 不加注解之前，访问首页：
  ...
  ![1595587645715](springboot学习.assets/1595587645715.png)

- 给配置类加上注解：`@EnableWebMvc`

  我们发现所有的SpringMVC自动配置都失效了！回归到了最初的样子；

  ![1595587533039](springboot学习.assets/1595587533039.png)
...
![1595594403624](springboot学习.assets/1595594403624.png)
...
2. 建立一个`login.properties`文件，还有一个`login_zh_CN.properties`；发现IDEA自动识别了我们要做国际化操作；文件夹变了！
   ...
   ![1595604595071](springboot学习.assets/1595604595071.png)

3. 我们可以在这上面去新建一个文件；

   ![1595604664699](springboot学习.assets/1595604664699.png)

   弹出如下页面：我们再添加一个英文的；

   ![1595605422294](springboot学习.assets/1595605422294.png)

   这样就快捷多了！

   ![1595605442883](springboot学习.assets/1595605442883.png)

4. **接下来，我们就来编写配置，我们可以看到idea下面有另外一个视图；**

   ![1595605469344](springboot学习.assets/1595605469344.png)

   这个视图我们点击 + 号就可以直接添加属性了；我们新建一个login.tip，可以看到边上有三个文件框可以输入

   ![1595605530046](springboot学习.assets/1595605530046.png)

   然后依次添加其他页面内容即可！

   ![1595605552329](springboot学习.assets/1595605552329.png)
...
![1595606566975](springboot学习.assets/1595606566975.png)

我们可以去启动项目，访问一下，发现已经自动识别为中文的了！

![1595606666498](springboot学习.assets/1595606666498.png)
...
![1595666066757](springboot学习.assets/1595666066757.png)
...
5. 访问测试 ：http://localhost:8080/swagger-ui.html ，可以看到swagger的界面；
   ...
   ![image-20200731132229265](springboot学习.assets/image-20200731132229265.png)
...
4. 重启项目，访问测试 http://localhost:8080/swagger-ui.html  看下效果；
   ...
   ![image-20200731161851136](springboot学习.assets/image-20200731161851136.png)
...
2. 重启项目测试，由于我们配置根据包的路径扫描接口，所以我们只能看到一个类
   ...
   ![image-20200731165837391](springboot学习.assets/image-20200731165837391.png)
...
![image-20200731190614381](springboot学习.assets/image-20200731190614381.png)
...
3. 可以在项目中增加配置文件
   ...
   - dev测试环境
     ...
     ![image-20200731193109826](springboot学习.assets/image-20200731193109826.png)

     项目运行结果

     ![image-20200731193425090](springboot学习.assets/image-20200731193425090.png)
   ...
   - pro测试环境
     ...
     ![image-20200731194455510](springboot学习.assets/image-20200731194455510.png)

     项目运行结果

     ![image-20200731194559290](springboot学习.assets/image-20200731194559290.png)
...
2. 重启项目查看分组
   ...
   ![image-20200731195354714](springboot学习.assets/image-20200731195354714.png)
...
4. 重启项目查看即可
   ...
   ![image-20200731195543102](springboot学习.assets/image-20200731195543102.png)
...
3. 重启查看测试
   ...
   ![image-20200731200413725](springboot学习.assets/image-20200731200413725.png)
...
1. 在HelloController控制类中的接口添加api接口注释
   ...
   ![image-20200731201755001](springboot学习.assets/image-20200731201755001.png)

2. 进行try it out测试

   ![image-20200731202958255](springboot学习.assets/image-20200731202958255.png)

   测试结果

   ![image-20200731203034702](springboot学习.assets/image-20200731203034702.png)
...
![image-20200731204929854](springboot学习.assets/image-20200731204929854.png)
...
![image-20200731205550845](springboot学习.assets/image-20200731205550845.png)
...
![image-20200731205723914](springboot学习.assets/image-20200731205723914.png)
...
2. 查看自动配置类：MailSenderAutoConfiguration
   ...
   ![image-20200801104504309](springboot学习.assets/image-20200801104504309.png)

   这个类中存在bean，JavaMailSenderImpl

   ![](springboot学习.assets/image-20200801104504309.png)
...
3. 配置文件：
   ...
   ![image-20200801105503766](springboot学习.assets/image-20200801105503766.png)
...
4. Spring单元测试
   ...
   ![image-20200801112646650](springboot学习.assets/image-20200801112646650.png)
...
![img](springboot学习.assets/dubbo-architecture-roadmap.jpg)

### 单一应用架构

当网站流量很小时，只需一个应用，将所有功能都部署在一起，以减少部署节点和成本。此时，用于简化增删改查工作量的数据访问框架(ORM)是关键。

![image-20200801133522303](springboot学习.assets/image-20200801133522303.png)
...
![image-20200801133625663](springboot学习.assets/image-20200801133625663.png)
...
![image-20200801133710784](springboot学习.assets/image-20200801133710784.png)

### 流动计算架构

当服务越来越多，容量的评估，小服务资源的浪费等问题逐渐显现，此时需增加一个调度中心基于访问压力实时管理集群容量，提高集群利用率。此时，用于**提高机器利用率的资源调度和治理中心**(SOA)[ Service Oriented Architecture]是关键。

![image-20200801133801873](springboot学习.assets/image-20200801133801873.png)
...
![image-20200801134404631](springboot学习.assets/image-20200801134404631.png)

![image-20200801134657756](springboot学习.assets/image-20200801134657756.png)
...
![dubbo-architucture](springboot学习.assets/dubbo-architecture.jpg)

![img](springboot学习.assets/architecture.png)
...
![image-20200801140529370](springboot学习.assets/image-20200801140529370.png)
...
1. 下载zookeeper ：[地址](https://mirror.bit.edu.cn/apache/zookeeper/)， 我们下载3.6.1， 最新版！解压zookeeper
   ...
   ![image-20200801173958146](springboot学习.assets/image-20200801173958146.png)
...
2. 运行/bin/zkServer.cmd ，初次运行会报错，没有zoo.cfg配置文件；
   ...
   ![image-20200801172648723](springboot学习.assets/image-20200801172648723.png)

   ![image-20200801173023636](springboot学习.assets/image-20200801173023636.png)
...
3. 修改zoo.cfg配置文件
   ...
   - 修改完成后再次启动zookeeper
     ...
     ![image-20200801174251778](springboot学习.assets/image-20200801174251778.png)

4. 使用zkCli.cmd测试

   - ls /：列出zookeeper根下保存的所有节点

     ![image-20200801175746901](springboot学习.assets/image-20200801175746901.png)

     报错别着急，多试几次就好了，我试了三次o(╥﹏╥)o，看报错信息

     ![image-20200801175928795](springboot学习.assets/image-20200801175928795.png)

   - create –e /kuangshen 123：创建一个kuangshen节点，值为123

     ![image-20200801180120251](springboot学习.assets/image-20200801180120251.png)

   - get /kuangshen：获取/kuangshen节点的值

     ![image-20200801180225001](springboot学习.assets/image-20200801180225001.png)

   - 我们再来查看一下节点：ls /

     ![image-20200801180302890](springboot学习.assets/image-20200801180302890.png)
...
![image-20200801181825286](springboot学习.assets/image-20200801181825286.png)
...
![image-20200801183043114](springboot学习.assets/image-20200801183043114.png)

登录成功后，查看界面

![image-20200801183113485](springboot学习.assets/image-20200801183113485.png)
...
![image-20200801204543375](springboot学习.assets/image-20200801204543375.png)

![image-20200801205620564](springboot学习.assets/image-20200801205620564.png)

![image-20200801205708690](springboot学习.assets/image-20200801205708690.png)
...
![image-20200801211028698](springboot学习.assets/image-20200801211028698.png)
...
![image-20200801221551593](springboot学习.assets/image-20200801221551593.png)



**监控中心 ：**

![image-20200801222026747](springboot学习.assets/image-20200801222026747.png)
...
2. 导入静态资源
   ...
   ![image-20200728130501139](springboot学习.assets/image-20200728130501139.png)
...
4. 测试实验环境是否OK！
   ...
   ![image-20200728130703899](springboot学习.assets/image-20200728130703899.png)

   登录

   ![image-20200728130726820](springboot学习.assets/image-20200728130726820.png)

   详情

   ![image-20200728130751338](springboot学习.assets/image-20200728130751338.png)
...
1. 引入 Spring Security 模块
   ...
   ![image-20200728175946604](springboot学习.assets/image-20200728175946604.png)
...
2. 编写 Spring Security 配置类
   ...
   - servlet-applications 8.16.4
     ...
     ![image-20200728175824524](springboot学习.assets/image-20200728175824524.png)

3. 编写基础配置类

   ![image-20200728180624787](springboot学习.assets/image-20200728180624787.png)
...
4. 定制请求的授权规则
   ...
   ![image-20200728190605894](springboot学习.assets/image-20200728190605894.png)
...
5. 测试一下：发现除了首页都进不去了！因为我们目前没有登录的角色，因为请求需要登录的角色拥有对应的权限才可以！
   ...
   ![image-20200728185841148](springboot学习.assets/image-20200728185841148.png)
...
7. 测试一下：发现，没有权限的时候，会跳转到登录的页面！
   ...
   ![image-20200728190113670](springboot学习.assets/image-20200728190113670.png)

8. 查看刚才登录页的注释信息；

   我们可以定义认证规则，重写configure的另一个方法

   ![image-20200728190303746](springboot学习.assets/image-20200728190303746.png)

   源码：

   ![image-20200728190840458](springboot学习.assets/image-20200728190840458.png)
...
9. 测试，我们可以使用这些账号登录进行测试！发现会报错！
   ...
   ![image-20200728204515545](springboot学习.assets/image-20200728204515545.png)

   ![image-20200728204424570](springboot学习.assets/image-20200728204424570.png)
...
3. 我们可以去测试一下，登录成功后点击注销，发现注销完毕会跳转到登录页面！
   ...
   ![image-20200728210246562](springboot学习.assets/image-20200728210246562.png)

   ![image-20200728210323067](springboot学习.assets/image-20200728210323067.png)

4. 但是，我们想让他注销成功后，依旧可以跳转到首页，该怎么处理呢？

   源码：

   ![image-20200728211500366](springboot学习.assets/image-20200728211500366.png)
...
8. 重启测试，我们可以登录试试看，登录成功后确实，显示了我们想要的页面；
   ...
   - 未登录
     ...
     ![image-20200728213100804](springboot学习.assets/image-20200728213100804.png)

   - 登录

     ![image-20200728213235625](springboot学习.assets/image-20200728213235625.png)

9. 点击注销产生的问题

   - 整合包4（springsecurity4）

     ![image-20200728220414292](springboot学习.assets/image-20200728220414292.png)

   - 整合包5（springsecurity5）（不算问题，需要点击确定，才能回到首页）

     ![image-20200728220517534](springboot学习.assets/image-20200728220517534.png)

     ![image-20200728220531678](springboot学习.assets/image-20200728220531678.png)
   ...
   ![image-20200728220835347](springboot学习.assets/image-20200728220835347.png)
...
- 用户首页未登录
  ...
  ![image-20200728221453455](springboot学习.assets/image-20200728221453455.png)

- 某个用户登录

  ![image-20200728221536116](springboot学习.assets/image-20200728221536116.png)
...
2. 我们再次启动项目测试一下
   ...
   - 发现登录页多了一个记住我功能
     ...
     ![image-20200728222312694](springboot学习.assets/image-20200728222312694.png)

   - 我们登录之后关闭 浏览器，然后重新打开浏览器访问，发现用户依旧存在！

     ![image-20200728222406216](springboot学习.assets/image-20200728222406216.png)

     <font color=red>思考：如何实现的呢？其实非常简单</font>

     我们可以查看浏览器的cookie

     ![image-20200728222706154](springboot学习.assets/image-20200728222706154.png)

3. 我们点击注销的时候，可以发现，spring security 帮我们自动删除了这个 cookie

   ![image-20200728223559077](springboot学习.assets/image-20200728223559077.png)
...
3. 我们登录，需要将这些信息发送到哪里，我们也需要配置，login.html 配置提交请求及方式，方式必须为post:
   ...
   ![image-20200728224246393](springboot学习.assets/image-20200728224246393.png)

4. 这个请求提交上来，我们还需要验证处理，怎么做呢？我们可以查看formLogin()方法的源码！我们配置接收登录的用户名和密码的参数！

   ![image-20200728224831116](springboot学习.assets/image-20200728224831116.png)
...
![image-20200729114702566](springboot学习.assets/image-20200729114702566.png)
...
- 官方的quickstart : https://github.com/apache/shiro/tree/master/samples/quickstart/
  ...
  ![image-20200729115148574](springboot学习.assets/image-20200729115148574.png)

1. 创建一个maven父工程，用来学习Shiro,删掉不必要的部分

2. 创建一个普通的Maven子工程：hell-shiro

   ![image-20200729120114648](springboot学习.assets/image-20200729120114648.png)

3. 根据[官方文档](https://github.com/apache/shiro/blob/master/samples/quickstart/pom.xml)，我们导入Shiro的依赖

   ![image-20200729120207730](springboot学习.assets/image-20200729120207730.png)
...
4. 相关配置文件
   ...
   - 启动类 Quickstart——[官网](https://github.com/apache/shiro/blob/master/samples/quickstart/src/main/java/Quickstart.java)
     ...
     ![image-20200729130649625](springboot学习.assets/image-20200729130649625.png)
...
1. 新建一个项目或模块，勾选依赖
   ...
   ![image-20200729174715011](springboot学习.assets/image-20200729174715011.png)
...
2. 测试环境是否正常
   ...
   - 项目结构
     ...
     ![image-20200729190325307](springboot学习.assets/image-20200729190325307.png)

   - 运行截图

     ![image-20200729190548307](springboot学习.assets/image-20200729190548307.png)
...
- 点击首页的add或者update之后
  ...
  ![image-20200729191619576](springboot学习.assets/image-20200729191619576.png)
...
- 拦截成功页面
  ...
  ![image-20200729192409085](springboot学习.assets/image-20200729192409085.png)
...
3. 用户输入登录信息
   ...
   - 页面
     ...
     ![image-20200729220647520](springboot学习.assets/image-20200729220647520.png)

   - 控制台

     ![image-20200729220926500](springboot学习.assets/image-20200729220926500.png)
...
7. 测试环境
   ...
   ![image-20200730121720922](springboot学习.assets/image-20200730121720922.png)
...
8. `UserRealm`连接真实数据库
   ...
   ![image-20200730180019861](springboot学习.assets/image-20200730180019861.png)

9. 断点测试密码加密类型

   - 打断点Debug

     ![image-20200730182621912](springboot学习.assets/image-20200730182621912.png)

   - 默认是`SimpleCredentialsMatcher`加密

     ![image-20200730181814293](springboot学习.assets/image-20200730181814293.png)
   ...
   - 所有加密
     ...
     ![image-20200730181944253](springboot学习.assets/image-20200730181944253.png)
...
2. 登录之后点击add按钮会弹出如下页面
   ...
   ![image-20200730195133631](springboot学习.assets/image-20200730195133631.png)
...
4. 再次测试
   ...
   ![image-20200730195807437](springboot学习.assets/image-20200730195807437.png)

   ![image-20200730195946692](springboot学习.assets/image-20200730195946692.png)
...
6. 再次测试
   ...
   ![image-20200730202810034](springboot学习.assets/image-20200730202810034.png)
...
4. 页面显示
   ...
   ![image-20200730205736153](springboot学习.assets/image-20200730205736153.png)
...
- 将css，js，img放入到static目录
  ...
  ![1595732299609](springboot学习.assets/1595732299609.png)
...
![1595732679388](springboot学习.assets/1595732679388.png)
...
![1595733308730](springboot学习.assets/1595733308730.png)
...
![1595733680599](springboot学习.assets/1595733680599.png)



再次看一下首页页面

![1595733822534](springboot学习.assets/1595733822534.png)
...
![1595734605852](springboot学习.assets/1595734605852.png)

登录失败页面

![1595734687171](springboot学习.assets/1595734687171.png)

3、登录页面不友好（密码泄露）

![1595735421990](springboot学习.assets/1595735421990.png)
...
- 修改`LoginController`跳转页面代码(redirect跳转)
  ...
  ![1595735326186](springboot学习.assets/1595735326186.png)
...
![1595736334324](springboot学习.assets/1595736334324.png)
...
![1595681333478](springboot学习.assets/1595681333478.png)
...
![1595683472896](springboot学习.assets/1595683472896.png)
...
![1595685749462](springboot学习.assets/1595685749462.png)
...
![1595685916526](springboot学习.assets/1595685916526.png)

添加成功页面

![1595685951486](springboot学习.assets/1595685951486.png)
...
![1595686182138](springboot学习.assets/1595686182138.png)
...
![1595730457032](springboot学习.assets/1595730457032.png)
...
![1595730489246](springboot学习.assets/1595730489246.png)
...
![1595731466761](springboot学习.assets/1595731466761.png)

错误运行页面

![1595731494875](springboot学习.assets/1595731494875.png)
...
![1595731955553](springboot学习.assets/1595731955553.png)
